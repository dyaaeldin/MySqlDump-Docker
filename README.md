...
* If you need to send backups to remote server you need to provide ssh public key in /keys/key as a docker volume or secret mounted as a volume in openshift.
